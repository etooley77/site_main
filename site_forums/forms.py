...
class CreatePost(forms.ModelForm):
	title = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Post Title", "class":"form-control"}), label="")
	content = forms.CharField(required=True, widget=forms.widgets.TextInput(attrs={"placeholder":"Post Content", "class":"form-control"}), label="")
